...
CREATE TABLE `airplane_company` (
  ...
  `Number_of_airplane` int NOT NULL,
...
INSERT INTO `airplane_company` VALUES (3,13192,'Airbus','Broughton, Chester CH4 0DR, UK'),(4,10000,'Boeing','Block 9A, 3rd Floor, DLF It Park Sez, 1/124 Shivaji Gardens, India');
